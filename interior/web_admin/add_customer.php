...
if($picture_type=="image/jpeg" || $picture_type=="image/jpg" || $picture_type=="image/png" || $picture_type=="image/gif")
{
	if($picture_size<=50000000)
	{
		...
		move_uploaded_file($picture_tmp_name,"../images/customers/".$pic_name);
		
mysqli_query($connection,"insert into clients( client_pic, client_name, client_details) values ('$pic_name','$name', '$details')") or die ("insert query incorrect");
...
<div class="panel-heading" style="background-color:#c4e17f">
    ...
    <div class="col-lg-4">
<form action="add_customer.php" class="form-group" name="form" method="post" enctype="multipart/form-data">
